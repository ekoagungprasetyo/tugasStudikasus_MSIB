        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" id="nama" class="form-control" autocomplete="off" name="nama" required>
                </div>
                <div>
            ...
            if (isset($_POST['simpan'])) {
                ...
                ?>
                            <div class="alert alert-warning mt-3" role="alert">
                                File tidak boleh melebihi dari 500 kb
                            </div>
                        <?php
                        ...
                        ?>
                                <div class="alert alert-warning mt-3" role="alert">
                                    File wajib Berupa jpg atau png atau gif
                                </div>
                <?php
                            }
                            else{
